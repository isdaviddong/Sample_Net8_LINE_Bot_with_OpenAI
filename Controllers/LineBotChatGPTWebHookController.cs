...
namespace isRock.Template
{
    public class LineBotChatGPTWebHookController : isRock.LineBot.LineWebHookControllerBase
    {
        ...
        {
            const string AdminUserId = "👉____Admin_User_Id______"; //👉repleace it with your Admin User Id

            try
            {
                //設定ChannelAccessToken
                this.ChannelAccessToken = "👉____Token____"; //👉repleace it with your Channel Access Token
                //配合Line Verify
    ...
    public class ChatGPT
    {
        ...
        {
            return ChatGPT.CallOpenAIChatAPI("👉sk-proj-IH______-key", //👉replace it with your OpenAI API Key
